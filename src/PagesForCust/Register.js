...
export default class Register extends React.Component {
  ...
  render() {
    return (
      ...
      <section className="bg-amber-50 bg-opacity-40">
        <div className="lg:grid lg:min-h-screen lg:grid-cols-12">
          ...
          <main className="flex items-center justify-center px-8 py-8 sm:px-12 lg:col-span-7 lg:px-16 lg:py-12 xl:col-span-6">
            <div className="max-w-xl lg:max-w-3xl ">
              ...
              <form onSubmit={(e) => this.handleRegister(e)} className="mt-8 grid grid-cols-4 gap-4">
                <div className="col-span-6">
                  ...
                  <input
                    ...
                    required
                    className="mt-1 w-full rounded-md border-gray-200  bg-blue-300 bg-opacity-30 text-gray-700 shadow-sm py-3 px-3"
                  />
                </div>
                ...
                <div className="col-span-6 ">
                  ...
                  <input
                    ...
                    onChange={this.handleChange} 
                    required
                    className="mt-1 w-full rounded-md border-gray-200  bg-blue-300 bg-opacity-30 text-gray-700 shadow-sm py-3 px-2"
                  />
                </div>
                ...
                <div className="col-span-6 sm:flex sm:items-center sm:gap-4">
                  <button className="inline-block shrink-0 rounded-md border bg-gradient-to-br from-lime-500 to-green-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 px-12 py-3 text-sm font-medium text-white transition" type="submit">
                    Create an account
                  </button>
